package com.susmote.ASCIIViewer;
...
public class ASCIIViewer extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -150662336729656119L;
	...
	public ASCIIViewer() {
		...
		asciiPanel.setFont(new Font("微软雅黑", Font.PLAIN, 16));
		asciiPanel.add(asciiTextField);
		asciiTextField.setColumns(3);
		
		JLabel label2 = new JLabel("装换结果");
		...
		JButton toNumberButton = new JButton("装换");
		toNumberButton.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				do_toNumberButon_actionPerformed(e);
			}

			private void do_toNumberButon_actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
        ...
        toASCIIButton.addActionListener(new ActionListener() {
			...
			private void do_toASCIIButton_actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub

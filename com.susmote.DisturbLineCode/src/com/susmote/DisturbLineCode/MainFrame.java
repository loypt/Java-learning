...
public class MainFrame extends JFrame {
	 ...
	 * coding by susmote
	 */
	private static final long serialVersionUID = -3572243309305827596L;
	...
	public MainFrame() {
		...
		setTitle("带干扰线的验证码");
		setResizable(false);
		imageCode = new DisturbCodePanel();
		...
		panel.add(label_1);
		 ...
		 final JLabel label1_1_1 = new JLabel();
		 label1_1_1.setText("验证码: ");
		 label1_1_1.setBounds(29, 95, 66, 18);
		 panel.add(label1_1_1);
		 ...
		 button_1.addActionListener(new ActionListener() {
			 ...
			 public void actionPerformed(ActionEvent e) {
				 ...
				 else if (username.equals("TexTec") && password.equals("TexTecBlog")){
				 	info = "恭喜，登录成功";
				 }else {
				 	info = "用户名或密码错误!";
				 }
